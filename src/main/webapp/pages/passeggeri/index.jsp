...
<div class="bg-image">
    <div class="overflow-auto cont">
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav">
                            <li class="nav-item d-flex align-items-center">
                                <a class="nav-link" href="#nexttrips"> Your next trips </a>
                            </li>
                            <li class="nav-item d-flex align-items-center">
                                <a class="nav-link" href="#gradethetrips"> Grade trips </a>
                            </li>
                            <li class="nav-item d-flex align-items-center">
                                <a class="nav-link" href="#lasttrips"> Last trips </a>
                            </li>
                            <li class="nav-item d-flex align-items-center">
                                <a class="nav-link" href="#yourgrades"> Your ratings </a>
                            </li>
                            <li class="nav-item d-flex align-items-center">
                                <a class="nav-link" href="#othertrips"> Other trips </a>
                            </li>
                        </ul>
        ...
        <div class="row">
            ...
            <div class="height righe" id="othertrips">
                <div class="wrapper fadeInDown">
                    <div class="homeDiv">
                        <br/>
                        <h1
